...
import { Check, Clock, ChevronDown, Home, CalendarDays, SlidersHorizontal, Play, Settings2 } from 'lucide-react';
...
function App() {
  ...
  useEffect(() => {
    const userChallenges = getUserChallengesFromLocalStorage();
    setCustomChallenges(userChallenges);
  }, []);
              ...
              <>
                ...
                <div className="mt-8 flex justify-center">
                  {selectedDay.type === 'repos' ? (
                    <button onClick={() => handleWorkoutComplete(selectedDay.day)} className="flex items-center gap-2 bg-[#10B981] text-white font-bold py-3 px-6 rounded-full shadow-lg hover:bg-[#059669] transition-transform hover:scale-105">
                      <Check />
                      Marquer comme terminé
                    </button>
                  ) : (
                    <button onClick={startWorkout} className="flex items-center gap-2 bg-[#10B981] text-white font-bold py-3 px-6 rounded-full shadow-lg hover:bg-[#059669] transition-transform hover:scale-105">
                      <Play />
                      Démarrer
                    </button>
                  )}
